  ...
  export default {
    ...
    mounted() {
      ...
      if (env.indexOf('MicroMessenger') > -1) {
        this.$http.get(this.$HOST + '/openapi/v2/app/hm/getWeixinConf'+'?'+'districtName='+decodeURIComponent(this.$route.query.districtName)).then((res) => {
    ...
    methods: {
      ...
      getCode() {
        //手机号正则验证
        let re = /^(0|86|17951)?(13[0-9]|15[012356789]|17[0-9]|18[0-9]|14[0-9]|19[0-9]|16[0-9])[0-9]{8}$/;
